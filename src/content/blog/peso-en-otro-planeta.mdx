...
author: 'Hans Martens'
tags: ['Física', 'Python', 'Gravedad', 'Astronomia']
featured: false
locale: es
...
.dark .hero-dark-gradient {
  background: linear-gradient(to bottom, var(--brand-700) 0%, oklch(0% 0 0) 100%) !important;
}
```
...
```html
<section class="your-existing-classes hero-dark-gradient"></section>
```
